"""Tributario output normalizer.

Pure function that best-effort normalizes TributarioOutput before strict
schema validation. Moved from supervisor.py to make it independently testable.
"""
...
def normalize_tributario_output(state: AgentState, tributario_output: Any) -> dict:
    """Best-effort normalization for TributarioOutput."""
