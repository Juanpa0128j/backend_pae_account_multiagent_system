...
class NitEntidad(BaseModel):
    ...
    nit: Optional[str] = Field(None, description="NIT with verification digit (e.g. 900123456-7)")
...
class FacturaItem(BaseModel):
    ...
    valor_total_sin_impuesto: Optional[Decimal] = Field(None, description="Subtotal without tax")
    impuestos: Optional[List[ItemImpuesto]] = Field(None, description="Taxes on this item")
    ...
    @field_validator("cantidad", "valor_unitario", "descuento", "valor_total_sin_impuesto", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class FacturaTotales(BaseModel):
    ...
    @field_validator(
        "subtotal_sin_impuestos", "total_descuentos", "total_iva", "total_inc",
        "total_otros_impuestos", "total_retenciones", "total_factura", "total_a_pagar",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class EmisorFactura(BaseModel):
    ...
    regimen: Optional[str] = Field(None, description="responsable_iva | no_responsable_iva | regimen_simple | gran_contribuyente")
    resolucion_facturacion: Optional[str] = Field(None, description="DIAN billing authorization number and date")
...
class FacturaVentaContent(ContentBase):
    ...
    medio_pago: Optional[str] = Field(None, description="efectivo | tarjeta_credito | transferencia | otro")
...
class FacturaCompraContent(ContentBase):
    ...
    totales: Optional[FacturaTotales] = Field(None)
    retenciones_aplicadas: Optional[List[Retencion]] = Field(None)
    documento_soporte: Optional[bool] = Field(None, description="True if support doc for non-invoicing party purchases")
...
class NotaCreditoContent(ContentBase):
    ...
    consecutivo: Optional[str] = Field(None)
    cude: Optional[str] = Field(None, description="Código Único de Documento Electrónico")
    fecha_emision: Optional[str] = Field(None, description="YYYY-MM-DD")
    factura_referencia: Optional[FacturaReferencia] = Field(None)
    concepto: Optional[str] = Field(None, description="devolucion | descuento | anulacion | correccion_valor | otro")
    ...
    @field_validator("subtotal_ajustado", "total_iva_ajustado", "total_nota_credito", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class NotaDebitoContent(ContentBase):
    ...
    fecha_emision: Optional[str] = Field(None, description="YYYY-MM-DD")
    factura_referencia: Optional[FacturaReferencia] = Field(None)
    concepto: Optional[str] = Field(None, description="intereses | ajuste_precio | penalizacion | otro")
    concepto_descripcion: Optional[str] = Field(None)
    emisor: Optional[EmisorFactura] = Field(None)
    receptor: Optional[ReceptorFactura] = Field(None)
    items: Optional[List[FacturaItem]] = Field(None)
    ...
    @field_validator("subtotal_adicionado", "total_iva_adicionado", "total_nota_debito", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class BankStatementContent(ContentBase):
    ...
    gmf_cobrado: Optional[Decimal] = Field(None, description="4x1000 financial transactions tax charged")
    intereses_generados: Optional[Decimal] = Field(None)
    retencion_fuente_rendimientos: Optional[Decimal] = Field(None)
    moneda: Optional[str] = Field("COP")
    informacion_adicional: Optional[Dict[str, Any]] = Field(None, description="Any other data relevant for downstream accounting.")

    @field_validator("saldo_inicial", "saldo_final", "gmf_cobrado", "intereses_generados", "retencion_fuente_rendimientos", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class ActividadEconomicaICA(BaseModel):
    ...
    tarifa_ica_por_mil: Optional[Decimal] = Field(None, description="Rate in per-thousand (e.g. 4.14)")
...
class LiquidacionICA(BaseModel):
    ...
    impuesto_avisos_tableros: Optional[Decimal] = Field(None, description="Usually 15% of ICA")
    ...
    @field_validator(
        "impuesto_ica", "impuesto_avisos_tableros", "sobretasa_bomberil",
        "total_impuesto_cargo", "menos_retenciones_practicadas", "menos_autorretenciones",
        "menos_anticipo_periodo_anterior", "mas_anticipo_periodo_siguiente",
        "sanciones", "intereses_mora", "total_a_pagar", "total_saldo_a_favor",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class DeclaracionICAContent(ContentBase):
    ...
    periodo_numero: Optional[int] = Field(None, description="Bimester 1-6 or month 1-12")
    nit_declarante: Optional[str] = Field(None)
    razon_social: Optional[str] = Field(None)
...
class DetalleAutorretencion(BaseModel):
    ...
    @field_validator("tarifa_retencion_por_mil", "base_gravable", "valor_autorretencion", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class AutoretencionICAContent(ContentBase):
    ...
    @field_validator("total_autorretenciones", "sanciones", "intereses_mora", "total_a_pagar", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class IVAGeneradoPorTarifa(BaseModel):
    tarifa: Optional[Decimal] = Field(None, description="Rate as decimal (0.19, 0.05, 0.00)")
    base_gravable: Optional[Decimal] = Field(None)
...
class IVADescontablePorConcepto(BaseModel):
    concepto: Optional[str] = Field(None, description="compras_gravadas | importaciones | servicios | honorarios | otro")
    tarifa: Optional[Decimal] = Field(None)
    base_gravable: Optional[Decimal] = Field(None)
...
class AnexoIVAContent(ContentBase):
    ...
    razon_social: Optional[str] = Field(None)
    anio: Optional[int] = Field(None)
    periodicidad: Optional[str] = Field(None, description="bimestral | cuatrimestral | anual")
    periodo_numero: Optional[int] = Field(None)
    ...
    @field_validator(
        "total_iva_generado", "total_iva_descontable", "saldo_a_pagar", "saldo_a_favor",
        "retenciones_iva_practicadas", "retenciones_iva_que_le_practicaron",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class CuentaIVA(BaseModel):
    ...
    tipo_iva: Optional[str] = Field(None, description="generado | descontable | por_pagar | retenido")
    saldo_inicial: Optional[Decimal] = Field(None)
    ...
    @field_validator("saldo_inicial", "total_debitos", "total_creditos", "saldo_final", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class AuxiliaryLedgerContent(ContentBase):
    ...
    entidad: Optional[NitEntidad] = Field(None)
    cuenta_principal: Optional[str] = Field(None, description="Main account code if specific to one account")
    periodo_inicio: Optional[str] = Field(None, description="YYYY-MM-DD")
    periodo_fin: Optional[str] = Field(None, description="YYYY-MM-DD")
...
class AccountBalance(BaseModel):
    ...
    nivel: Optional[int] = Field(None, description="Hierarchy level: 1=class, 2=group, 3=account, 4=subaccount")
...
class FinancialStatementContent(ContentBase):
    ...
    tipo: Literal["balance_general", "estado_resultados"] = Field(description="Statement type")
    entidad: Optional[NitEntidad] = Field(None)
    ...
    accounts: Optional[List[AccountBalance]] = Field(None, description="All PUC accounts with balances")
    informacion_adicional: Optional[Dict[str, Any]] = Field(None, description="Any other data relevant for downstream accounting.")
...
class LibroDiarioContent(ContentBase):
    ...
    periodo_inicio: Optional[str] = Field(None, description="YYYY-MM-DD")
    periodo_fin: Optional[str] = Field(None, description="YYYY-MM-DD")
    asientos: Optional[List[Dict[str, Any]]] = Field(None, description="Journal entries with date, comprobante, accounts, debits, credits")
    total_debitos: Optional[Decimal] = Field(None)
    total_creditos: Optional[Decimal] = Field(None)
    moneda: Optional[str] = Field("COP")
    informacion_adicional: Optional[Dict[str, Any]] = Field(None, description="Any other data relevant for downstream accounting.")
...
class FlujoDeCajaContent(ContentBase):
    ...
    verificacion: Optional[bool] = Field(None, description="True if efectivo_inicio + variacion == efectivo_fin")
    moneda: Optional[str] = Field("COP")
    informacion_adicional: Optional[Dict[str, Any]] = Field(None, description="Any other data relevant for downstream accounting.")

    @field_validator(
        "flujo_neto_operacion", "flujo_neto_inversion", "flujo_neto_financiacion",
        "aumento_disminucion_neto", "efectivo_inicio_periodo", "efectivo_fin_periodo",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class ComponentePatrimonio(BaseModel):
    concepto_patrimonio: Optional[str] = Field(None, description="capital_social | prima_emision | reservas | resultados_acumulados | resultado_ejercicio | ORI | otro")
    saldo_inicial: Optional[Decimal] = Field(None)
    movimientos: Optional[List[Dict[str, Any]]] = Field(None)
    saldo_final: Optional[Decimal] = Field(None)
...
class NotaFinanciera(BaseModel):
    ...
    categoria: Optional[str] = Field(None, description="politicas_contables | estimaciones_juicios | detalle_partida | contingencias | hechos_posteriores | partes_relacionadas | impuestos | otra")
    contenido_resumido: Optional[str] = Field(None, description="Summary of the note key content (max 500 words)")
...
class NotasEstadosFinancierosContent(ContentBase):
    ...
    base_presentacion: Optional[str] = Field(None, description="NIIF_plenas | NIIF_pymes | NIF_microempresas")
...
class ComprobanteEgresoContent(ContentBase):
    ...
    valor_neto: Optional[Decimal] = Field(None, description="Net payment after retentions")
    forma_pago: Optional[str] = Field(None, description="efectivo | cheque | transferencia | otro")
...
class DocumentoSoporteContent(ContentBase):
    ...
    fecha_emision: Optional[str] = Field(None, description="YYYY-MM-DD")
    proveedor: Optional[EmisorFactura] = Field(None, description="Non-invoicing supplier")
...
class ReciboCajaContent(ContentBase):
    ...
    informacion_adicional: Optional[Dict[str, Any]] = Field(
        None,
        description="Any other data relevant for downstream accounting."
    )
...
class EmpleadoNomina(BaseModel):
    ...
    @field_validator(
        "salario_basico", "devengado_total", "deduccion_salud", "deduccion_pension",
        "deduccion_retefuente", "otras_deducciones", "total_deducciones", "neto_pagar",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class NominaContent(ContentBase):
    ...
    aportes_patronales: Optional[Dict[str, Any]] = Field(None, description="Employer contributions: salud, pension, ARL, SENA, ICBF, caja")
    moneda: Optional[str] = Field("COP")
    informacion_adicional: Optional[Dict[str, Any]] = Field(
        None,
    ...
    @field_validator("total_devengado", "total_deducciones", "total_neto_pagar", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class PartidaConciliatoria(BaseModel):
    descripcion: Optional[str] = Field(None)
    fecha: Optional[str] = Field(None, description="YYYY-MM-DD")
    tipo: Optional[str] = Field(None, description="cheque_en_transito | deposito_en_transito | nota_debito | nota_credito | error | otro")
    valor: Optional[Decimal] = Field(None)
...
class ConciliacionBancariaContent(ContentBase):
    ...
    @field_validator("saldo_segun_extracto", "saldo_segun_libros", "saldo_conciliado", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class AporteEmpleado(BaseModel):
    ...
    @field_validator("salario_base", "aporte_salud_empleado", "aporte_salud_empleador",
                     "aporte_pension_empleado", "aporte_pension_empleador", "aporte_arl", "aporte_caja", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
...
class PlanillaSegSocialContent(ContentBase):
    ...
    @field_validator(
        "total_salud", "total_pension", "total_arl", "total_caja",
        "total_parafiscales", "total_a_pagar",
        mode="before",
    )
    @classmethod
    def parse_amounts(cls, v):
...
class ReciboPagoImpuestoContent(ContentBase):
    ...
    tipo_impuesto: Optional[str] = Field(None, description="IVA | renta | ICA | GMF | retefuente | reteica | otro")
    ...
    @field_validator("valor_principal", "sanciones", "intereses", "total_pagado", mode="before")
    @classmethod
    def parse_amounts(cls, v):
        return _parse_decimal(v)
