...
def build_via_b_documents(output_dir: Path, company_nit: str = "800999888-2") -> list[UploadRun]:
    ...
    _write_pdf(
        ...
        [
            ...
            "2024-01-15  CE-001       900123456-1    Recaudo clientes       5,000,000.00       0.00      5,000,000.00",
            "2024-02-01  CE-012       800555333-1    Pago arriendo              0.00       2,000,000.00  3,000,000.00",
            "2024-03-15  CE-025       900123456-1    Recaudo cartera        8,000,000.00       0.00     11,000,000.00",
            "2024-06-20  CE-048       800555333-1    Pago servicios             0.00       1,000,000.00 10,000,000.00",
            "",
            "Cuenta PUC: 1110 - BANCOS",
            "Fecha       Comprobante  Tercero NIT    Descripcion              Debito         Credito        Saldo",
            "2024-01-20  RC-001       900123456-1    Consignacion cliente  45,000,000.00       0.00     45,000,000.00",
            "2024-02-15  CE-015       800444222-1    Pago proveedor             0.00      10,000,000.00 35,000,000.00",
            "2024-04-10  RC-030       900123456-1    Consignacion          15,000,000.00       0.00     50,000,000.00",
            "",
            "Cuenta PUC: 2205 - PROVEEDORES NACIONALES",
            "Fecha       Comprobante  Tercero NIT    Descripcion              Debito         Credito        Saldo",
            "2024-01-10  FV-001       800444222-1    Compra mercancia           0.00      20,000,000.00 20,000,000.00",
            "2024-02-15  CE-015       800444222-1    Pago factura          10,000,000.00       0.00     10,000,000.00",
        ],
    )
